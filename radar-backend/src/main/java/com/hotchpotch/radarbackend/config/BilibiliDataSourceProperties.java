 ...
 * B站数据源请求配置。
 */
@ConfigurationProperties(prefix = "radar.bilibili")
public class BilibiliDataSourceProperties {

    /**
     * B站 API 根地址。
     */
    private String apiBaseUrl = "https://api.live.bilibili.com";

    /**
     * B站直播间网页根地址。
     */
    private String webBaseUrl = "https://live.bilibili.com";
