 ...
 * 斗鱼数据源请求配置。
 */
@ConfigurationProperties(prefix = "radar.douyu")
public class DouyuDataSourceProperties {

    /**
     * 斗鱼主数据源根地址。
     */
    private String apiBaseUrl = "https://www.douyu.com";

    /**
     * 斗鱼直播间网页根地址。
     */
    private String webBaseUrl = "https://www.douyu.com";
