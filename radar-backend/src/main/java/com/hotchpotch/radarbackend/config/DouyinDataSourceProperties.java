 ...
 * 抖音数据源请求配置。
 */
@ConfigurationProperties(prefix = "radar.douyin")
public class DouyinDataSourceProperties {

    /**
     * 抖音直播 JSON 接口根地址。
     */
    private String apiBaseUrl = "https://live.douyin.com";

    /**
     * 抖音直播页面根地址。
     */
    private String webBaseUrl = "https://live.douyin.com";
