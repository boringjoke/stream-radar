...
@EnableConfigurationProperties(DouyinDataSourceProperties.class)
public class DouyinDataSourceConfig {

    /**
     * 创建抖音数据源专用 WebClient。
     *
     * @param properties 抖音数据源配置
     * @return 抖音数据源 HTTP 客户端
     */
    @Bean(name = "douyinWebClient")
    public WebClient douyinWebClient(DouyinDataSourceProperties properties) {
